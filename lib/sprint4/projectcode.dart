...
import '../main.dart';
import 'package:finalapp/sprint4/viewaskedviva.dart';
import 'dart:convert';
...
class _RegisterState extends State<Register> {
  ...
  Future <void> getoneviva() async{
    String uri="http://192.168.187.158/crud/specificvivaview.php";
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                        gradient: LinearGradient(colors: [
                          Color.fromARGB(255, 86, 237, 141),
                          Color.fromARGB(255, 76, 153, 225)
                        ]),
                        boxShadow: [
                          BoxShadow(
                              blurRadius: 4,
